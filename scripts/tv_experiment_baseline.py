...
OUTPUT_PATH = Path(
    f"{date}/noise_{NOISE_LEVEL}_20_200_40_init_{INIT}_const-jumps_als".replace(".", "-")
)
...
if __name__ == "__main__":
    ...
    Parallel(n_jobs=50)(delayed(run_baseline_experiment)(dataset_num) for dataset_num in range(NUM_DATASETS))
